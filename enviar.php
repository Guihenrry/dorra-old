...
// Mudar Aqui o e-mail
$email_envio = 'contato@dorra.com.br'; // E-mail do site (ex: contato@seusite.com)
$email_pass = 'tmdginn7'; // Senha do e-mail

$site_name = 'Dorra'; // Nome do Site
$site_url = 'https://dorra.com.br/'; // URL do Site

$host_smtp = 'mail.dorra.com.br'; // HOST SMTP Ex: smtp.domain.com.br
$host_port = '26'; // Porta do Host, geralmente 465 ou 587
